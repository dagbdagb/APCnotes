# Notes for CLI management of APC NMCs
...
A link to the official CLI management guide is provided below.

Finally, a simple bash-script at the end of this document provides for a quick way to print the essential CLI commands for configuring your APC NMC, ready to cut and paste. 
...
- APC *ATS*es have a *particular procedure* to follow for installing firmware. **Disregarding this may damage your ATS and/or depower loads.**
...
We differentiate between the primary function (UPS, PDU, ATS)   
and    
the NMC (Network Management Card) of your APC device.

UPS and ATS (and PDU?) have firmwares for their primary function (which is distinct from the NMC firmware), and which is downloaded and installed independently. 
...
**-->  Do note:** you must provide a target **filename** when scp'ing a file to an APC NMC, not just the directory. **<--**
